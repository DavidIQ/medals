...
$lang = array_merge($lang, array(
	...
	'MEDALS_MOD_INSTALLED'			=> 'Medals Extension version %s installed',
	'MEDALS_MOD_UPDATED'			=> 'Medals Extension updated to version %s',
	'MEDALS_MOD_MANUAL'				=> 'You have an older version of Medals Extension installed.<br />You will need to uninstall that version first<br />Be sure to make backups first.',

	'ACL_U_AWARD_MEDALS'			=> 'Can award medals to users',
	'ACL_U_NOMINATE_MEDALS'			=> 'Can nominate medals to other users',
	'ACL_A_MANAGE_MEDALS'			=> 'Can use the medals management module',
